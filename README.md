...
The code to produce the model can be found [Here!](https://github.com/OP78142/UTSA-Bootcamp-Final/blob/main/MachineLearningAnalysis.ipynb)</br></br>
...
### Tableau
Tableau was leveraged to create an interactive dashboard to determine where the higher levels of fraud were occurring. They can be found at the following locations [1990-2000](https://public.tableau.com/views/FraudovertheYears/Fraudfor1990-2000?:language=en-US&:display_count=n&:origin=viz_share_link) , [2001-2010](https://public.tableau.com/views/FraudovertheYears2001/Fraudfor2001-2010?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link ), and [2011-2019](https://public.tableau.com/views/FraudovertheYears2011/Fraudfor2011-2019?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link ).</br>
